      ...
      <div class="container has-text-centered">
        <div class="columns is-vcentered">
          <div class="column is-5">
            <figure class="image">
              <img class="object-fit" src="/map.jpg" alt="map" />
            </figure>
          </div>
          <div class="column is-6 is-offset-1">
            ...
            <h2 class="subtitle is-4 mt-2">Create your Points of Interests</h2>
            <p class="has-text-centered">
              <a class="button is-medium is-warning" href="/signup">
                <span class="icon"><i class="fas fa-plus"></i></span><span>Sign Up</span>
              </a>
              <a class="button is-medium is-primary" href="/login">
